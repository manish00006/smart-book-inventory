          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/70 max-w-xl">
                Your cloud database is sleeping on Supabase Free Tier. We are displaying 7 offline sample books so you can test the UI. To restore your real 106+ cloud books, sign into Supabase (using GitHub) and unpause project <strong>aqujpupaiixneqhsnfak</strong>.
              </p>
            </div>
          </div>
