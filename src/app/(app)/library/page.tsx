        ...
        <div className="relative overflow-hidden rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 via-blue-500/5 to-transparent p-6 sm:p-8 text-center shadow-2xl backdrop-blur-xl mb-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
            <div className="flex items-center gap-4 text-left">
              <div className="w-12 h-12 bg-amber-500/20 border border-amber-500/40 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-amber-500/5">
                <AlertTriangle className="w-6 h-6 text-amber-400" />
              </div>
              <div>
                <h3 className="text-lg font-outfit font-bold text-white mb-1">Cloud DB Paused — Showing 7 Sample Offline Books</h3>
                <p className="text-white/70 text-sm max-w-xl leading-relaxed">
                  Your cloud database is sleeping on Supabase Free Tier. We are displaying 7 offline sample books so you can test the UI. To restore your real 106+ cloud books, sign into Supabase (using your GitHub account) and unpause project <strong>aqujpupaiixneqhsnfak</strong>.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3 w-full md:w-auto flex-shrink-0">
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 md:flex-initial px-5 py-2.5 bg-amber-500 hover:bg-amber-400 text-white rounded-xl font-bold transition-all shadow-lg shadow-amber-500/20 text-center text-xs sm:text-sm flex items-center justify-center gap-2"
              >
                <Sparkles className="w-4 h-4 animate-pulse" />
                Unpause Cloud DB (Sign in with GitHub)
              </a>
              <button 
                onClick={loadBooks}
                className="flex-1 md:flex-initial px-5 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-xl font-semibold transition-all text-xs sm:text-sm"
              >
                Retry
              </button>
              <button
